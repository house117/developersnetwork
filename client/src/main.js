...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    add: function (core) {
        ...
        console.log("porfis"+contextVideo.videoInputFile);
    ...
    submitAction: function (fileList) {
        if (fileList.length === 0) return;
        console.log("entro al submit action entonces aqui no es el problema!")
        let fileSize = 0;
        const files = [];
        for (let i = 0, len = fileList.length; i < len; i++) {
        ...
        console.log("URL RECIBIDA ES: "+this.context.option.videoUploadUrl)
        ...
        if (typeof videoUploadUrl === 'string' && videoUploadUrl.length > 0) {
            ...
            this.plugins.fileManager.upload.call(this, videoUploadUrl, 
                this.context.option.videoUploadHeader, formData, 
        ...
        if (typeof videoUploadUrl === 'string' && videoUploadUrl.length > 0) {
            ...
            //console.log(contextVideo.videoInputFile.value);
            var file = contextVideo.videoInputFile.files[0];
            console.log("file:");
            console.log(file);
            console.log("before require");
            //SUBIENDO A DROPBOX
            /*var Dropbox = require('dropbox').Dropbox;
            console.log("KEPAZAAQUI???");
            var dbx = new Dropbox({ accessToken: "6uUeHD-bQuAAAAAAAAAAVHWki84l_-Gqp0C2wU8Uw3BTIzTHNQknKQ8asohcRtze"});
            console.log("secreo el objeto dropbox");
            ...
            /*
            const srcLink = await dbx.sharingCreateSharedLink({
            ...
            */
            ...
            /*this.plugins.fileManager.upload.call(this, videoUploadUrl, 
                ...
                const videoTag = this.util.createElement('VIDEO');
                videoTag.setAttribute('controls', true);
                this.plugins.video.create_video.call(this, (info.isUpdate ? info.element : videoTag.cloneNode(false)), "URL", info.inputWidth, info.inputHeight, info.align, file, info.isUpdate);
...
var SunEditor_SunEditor = /*#__PURE__*/function (_Component) {
  ...
  _createClass(SunEditor, [{
    ...
    value: function componentDidMount() {
      ...
      //AQUIESTAONVIDEOUPLOAD
      if (onVideoUpload) this.editor.onVideoUpload = function (files, targetElement, index, state, info, remainingFilesCount) {
        return onVideoUpload(files, targetElement, index, state, info, remainingFilesCount);
      };
